...
class FAQRouter:
    ...
    def _load_cache(self):
        file_path = os.path.join(
            os.path.dirname(os.path.abspath(__file__)), "..", "data", "faq_cache.json"
        )
    ...
    def search_fast_lane(self, query: str):
        ...
        print(
            f"❌ [FAQ Router]: Совпадений не найдено (Макс. точность {best_score*100:.1f}%). Маршрутизирую в Deep RAG..."
        )
        return None
    ...
    def learn_new_answer(self, query: str, answer: str):
        ...
        new_entry = {"id": new_id, "question": query, "answer": answer}
