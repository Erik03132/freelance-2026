...
env_path = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "..", "..", "freelance-agent", ".env"
)
    ...
    try:
        search_res = pplx_client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a professional financial journalist in Russia. Find only verified and recent news for April 2026.",
                },
