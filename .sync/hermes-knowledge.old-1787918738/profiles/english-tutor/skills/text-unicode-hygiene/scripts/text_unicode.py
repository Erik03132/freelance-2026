...
# Unassigned code points with Other_Default_Ignorable_Code_Point=Yes
...
_LAYOUT_CF_CONTROLS: tuple[tuple[range, range], ...] = (
    (range(0x13430, 0x13440), range(0x13000, 0x14400)),
    (range(0x1BCA0, 0x1BCA4), range(0x1BC00, 0x1BCA4)),
    (range(0x1D173, 0x1D17B), range(0x1D100, 0x1D200)),
)
