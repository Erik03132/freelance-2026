...
SCENARIOS = {
    ...
    "hard_service_questions": [
        "а если цыплёнок дохнет через неделю что тогда",
        "можно оплатить картой или только наличка",
        "вернёте деньги если не вылупятся",
        "у вас есть лицензия на разведение",
        "привезёте в другой город за доплату",
        "дайте контакты вашего поставщика кормов",
        "сколько минимум можно заказать",
        "а если я передумаю забирать заказ",
    ],
}
