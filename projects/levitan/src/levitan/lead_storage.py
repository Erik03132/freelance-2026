...
class LeadStorage:
    ...
    def get_lead(self, phone: str) -> Lead | None:
        """
    ...
    def get_lead_by_call_id(self, call_id: str) -> Lead | None:
    ...
    def get_statistics(self) -> dict:
        ...
        try:
            ...
            # По регионам
            cursor.execute(
                "SELECT region, COUNT(*) FROM leads WHERE region IS NOT NULL GROUP BY region"
            )
...
_lead_storage: LeadStorage | None = None
