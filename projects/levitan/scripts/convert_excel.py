...
def convert_excel_to_csv(excel_path: Path, output_dir: Path, sheet_name: str = None) -> Path:
    """
...
def convert_all_excel_in_dir(input_dir: Path, output_dir: Path) -> list[Path]:
    """
...
def merge_csv_files(csv_files: list[Path], output_path: Path) -> Path:
    """
